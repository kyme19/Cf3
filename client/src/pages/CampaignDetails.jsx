      ...
      <div className='mt-[60px] flex lg:flex-row flex-col gap-5'>
         <div className='flex-[2] flex flex-col gap-[40px]'>
          ...
          <h4 className="font-epilogue font-semibold text-[18px] text-white
            uppercase">Creator</h4>

            <div className='mt-[20px] flex flex-row items-center flex-wrap gap-[14px]'>
              <div className='w-[52px] h-[52px] flex 
              items-center justify-center rounded-full bg-[#2c2f32] cursor-pointer'>
                <img src={thirdweb} alt="user" className='w-[60%] h-[60%] object-contain'/>
              </div>
              <div>
                <h4 className='font-epilogue font-semibold 
                text-[14px] text-white break-all'>{state.owner}</h4>
                <p className='mt-[4px] font-epilogue 
                font-normal text-[12px] text-[#808191]'>10 campaigns</p>
              </div>
            </div>
          </div>
          ...
          <h4 className="font-epilogue font-semibold text-[18px] text-white 
            ...
            <div className='mt-[20px]'>
              ...
              text-[16px] text-[#808191] leading-[26px] text-justify'>{state.description}</p>
            </div>
          </div>
            ...
            <div className='mt-[20px] flex flex-col gap-4'>
              ...
              index) => (
                ...
                className='flex justify-between items-center gap-4'>
                  <p className='font-epilogue font-normal text-[#b2b3bd] leading-[26px] break-ll'>
                    {index + 1}. {item.donator}</p>
                    <p className='font-epilogue font-normal text-[#808191] leading-[26px] break-ll'>
                    {item.donation}</p>
                </div>  
              )) : (
              <p className='font-epilogue font-normal
              text-[16px] text-[#808191] leading-[26px] text-justify'>No donators yet. 
              Be the first one</p>
              )}
            </div>
          </div>
         ...
         <h4 className="font-epilogue font-semibold text-[18px] text-white 
            ...
            <div className='mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]'>
                 ...
                 leading-[30px] text-center text-[#808191]'>Fund the campaign</p>
                 <div className='mt-[30px]'>
                      ...
                      <div className='my-[20px] p-4 bg-[#13131a] rounded-[10px]'>
                          <h4 className='font-epilogue font-semibold text-[14px] leading-[22px] text-white'>
                            Back it because you believe in it.</h4>
                           <p className='mt[20px] font-epilogue font-normal leading-[22px] text-[#808191]'>
                            Support the project for no reward just because it speaks yo you.</p>
                      </div>
